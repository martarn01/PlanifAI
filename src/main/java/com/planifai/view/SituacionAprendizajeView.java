 ...
 * @author marta
 */
public class SituacionAprendizajeView extends javax.swing.JFrame {

    /**
     * Creates new form MainFrame
     */
    public SituacionAprendizajeView() {
        initComponents();
        ...
        this.setExtendedState(SituacionAprendizajeView.MAXIMIZED_BOTH);//maximizada por defecto
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SituacionAprendizajeView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SituacionAprendizajeView().setVisible(true);
            }
        });
    }
