 ...
 * @author marta
 */
public class GeneracionSituacionAprendizajeView extends javax.swing.JFrame {

    /**
     * Creates new form MainFrame
     */
    public GeneracionSituacionAprendizajeView() {
        initComponents();
        ...
        this.setExtendedState(GeneracionSituacionAprendizajeView.MAXIMIZED_BOTH);//maximizada por defecto
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GeneracionSituacionAprendizajeView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GeneracionSituacionAprendizajeView().setVisible(true);
            }
        });
    }
